...
export default function BackMatterPage() {
  return (
    <div className="p-6">
      <Breadcrumbs />
      <h1 className="text-2xl font-semibold mb-4">Back Matter</h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
        <SectionCard href="/back-matter/references" title="References (Bibliography)" />
        <SectionCard href="/back-matter/appendices" title="Appendices" />
      </div>
    </div>
  );
}
